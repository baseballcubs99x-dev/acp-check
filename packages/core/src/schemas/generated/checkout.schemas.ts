...
export const checkoutSchemas = {
  ...
  "x-acp-source": "spec-snapshots/2026-07-05/openapi/openapi.agentic_checkout.yaml (info.version 2026-04-17)",
  "$defs": {
    "Address": {
      "type": "object",
...
export default checkoutSchemas as Record<string, unknown>;
